...
public class MyServletRequest implements HttpServletRequest {
    ...
    public MyServletRequest(String requestString) {
        parameters = new HashMap<>();
        String[] requestStringParts = requestString.split(" ");
        method = requestStringParts[0];
        System.out.println("METHOD: " + method.equals("GET"));
        String[] parameterStringParts = requestStringParts[1].split("\\?");
        if (parameterStringParts.length > 1) {
            String[] parameterParts = parameterStringParts[1].split("&");
            for (String parameterPart : parameterParts) {
                ...
                parameters.put(parameter[0], parameter[1].split(","));
            }
        }
    }
    @Override
